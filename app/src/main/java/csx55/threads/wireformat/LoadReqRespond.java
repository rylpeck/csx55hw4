...
class LoadReqRespond implements Event, Protocol{
    ...
    public int getType(){
        ...
        return LOAD_REQ_RESPOND;
    }

    @Override
    public byte[] getBytes(){
        byte[] marshalledBytes = null;
        Event access = new LoadReqRespond();
    ...
    public void setData(String Message){
        ...
        String[][] newdata = new String[][]{{commandBroken[0]}, {commandBroken[1]}, {commandBroken[2]}};
        this.data = newdata;
    }
