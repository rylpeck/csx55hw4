...
class SendTask implements Event, Protocol{
    ...
    public void setData(String Message){
        ...
        String[] newArray = deepCopyArray(commandBroken, 2, (commandBroken.length));
        
        String[][] newdata = new String[][]{{commandBroken[0], commandBroken[1]}, newArray};
        this.data = newdata;
    }
